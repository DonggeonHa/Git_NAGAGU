...
<head>
    ...
    <!-- 페이지 고유 스타일 -->
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/Mypage/Workshop/workshop_est_offers.css">
...
<div class="work_container">
    ...
    <!-- 작업 구역 -->
    <div class="work_main">
        <div class="work_store_category_body">
            <div class="work_title">
                ...
                <div class="header2 row p-2">
                    <h1 class="col-3 header2_adj">견적 제안 관리</h1>
