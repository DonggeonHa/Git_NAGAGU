...
<body class="order-body">
				...
				<div class="carousel-inner text-center">
                  ...
                  %>
					<div class="carousel-item active"
						style="width: 1300px; height: 530px;">
						<img
							src="/productupload/image/<%=vo.getPRODUCT_BANNER().split(",")[i]%>"
							class="d-block w-100" style="max-width: 100%; height: 100%;">
					</div>
					<%
                                continue;
                            }
		...
		<div class="row">
			<div class="col-8">
				<div style="line-height: 0.5em;" id="t1">
					<dl>
						<dt>
							<h3><%=vo.getPRODUCT_TITLE() %></h3>
							<br>
						</dt>
						<dl>
							<h5><%=vo.getPRODUCT_BRIEF() %></h5>
						</dl>
					</dl>
				</div>
				<div class="row sticky">
					<div class="col-12">
						<ul class="nav nav-tabs nav-fill h-30">
							<li class="nav-item"><a class="nav-link" href="#t1"><h5>상품정보</h5></a>
							</li>
							<li class="nav-item"><a class="nav-link" href="#t2"><h5>리뷰</h5></a>
							</li>
							<li class="nav-item"><a class="nav-link" href="#t3"><h5>Q&A</h5></a>
							</li>
							<li class="nav-item"><a class="nav-link" href="#t4"><h5>배송/환불</h5></a>
							</li>
						</ul>
					</div>
				</div>
               ...
               %>
				...
				<div class="reviews_table">
					...
					<div class="review_sum justify-content-center">
						<div class="row justify-content-center reviewspace"></div>
					</div>
					<!-- 댓글 출력 -->
					<%
               if (reviewCount > 0) {
            ...
            %>
					...
					<div class="review_sum justify-content-center"
						id="review_<%=reviewVO.getREVIEW_NUM() %>">
						<div class="row justify-content-center">
							<div class="col-1 justify-content-end">
								<img src="<%=memberVO.getMEMBER_PICTURE() %>" alt=""
                        ...
                        %>
                           ...
                           %>
										<img
											src="/productupload/image/<%=reviewVO.getREVIEW_FILE().split(",")[k]%>"
											class="review_img"> &nbsp;&nbsp;
                           ...
                           %>
								...
								<div class="pb-1 ">
									...
									<div class="review_re pr-4">
										<a id="review_re_insert_form<%=reviewVO.getREVIEW_NUM() %>"
											class="review_re_insert_form" style="cursor: pointer;"> <input
											type="hidden" name="REVIEW_NUM"
											value="<%=reviewVO.getREVIEW_NUM() %>"> 답글
										</a>
									</div>
								</div>
								<!-- 리뷰 수정, 삭제 (review)-->
								<div class="review_control_hidden pb-3 "
									id="review_control<%=reviewVO.getREVIEW_NUM() %>">
									<div class="review_control pr-4">
										<form name="review_numform">
											<a class="review_modify" style="cursor: pointer;"> <input
												type="hidden" name="REVIEW_NUM"
												value="<%=reviewVO.getREVIEW_NUM() %>"> 수정
											</a> &nbsp; <a class="review_delete" style="cursor: pointer;">
												<input type="hidden" name="REVIEW_NUM"
												value="<%=reviewVO.getREVIEW_NUM() %>"> 삭제
											</a>
										</form>
									</div>
								</div>
								...
								<div>
									<div class="review_re_hidden pt-3"
										id="review_re_hidden_<%=reviewVO.getREVIEW_NUM() %>">
										<div class="row">
											<div class="col-1">
												<%
                                    if(MEMBER_NICK != null) {
                                 ...
                                 %>
											...
											<div class="col-11">
												<form name="review_re_form"
													id="review_re_form<%=reviewVO.getREVIEW_NUM() %>">
													<input type="hidden" name="REVIEW_PRODUCT"
														value="<%=reviewVO.getREVIEW_PRODUCT() %>"> <input
														type="hidden" name="REVIEW_NUM"
														value="<%=reviewVO.getREVIEW_NUM() %>"> <input
														type="hidden" name="REVIEW_RE"
														value="<%=reviewVO.getREVIEW_NUM() %>">
													<textarea name="REVIEW_CONTENT" placeholder="답글을 작성해주세요!"
								...
								<div class="review_re_insert_hidden pb-3 "
									id="review_re_insert<%=reviewVO.getREVIEW_NUM() %>">
									<div class="review_re_insert pr-4">
										<a class="review_insert_re" style="cursor: pointer;"> <input
											type="hidden" name="REVIEW_NUM"
											value="<%=reviewVO.getREVIEW_NUM() %>"> 답글 작성
										</a>
									</div>
								</div>
							</div>
					...
					<!-- 리뷰 수정폼 추가 (ajax로 추가됨) -->
					<div class="review_mod_sum justify-content-center"
						id="review_mod_<%=reviewVO.getREVIEW_NUM() %>"></div>
					<!-- 리뷰 수정폼 끝 -->
						...
						<div class="row">
							...
							<div class="col-11">
								<div class="review_re_sum justify-content-center pr-2">
									...
									<div class="row review_re_space justify-content-center"
										id="review_re_space<%=reviewVO.getREVIEW_NUM() %>"></div>
								</div>
							</div>
						</div>
					</div>
            ...
            %>
					<!-- 답글 리스트 출력(review_re) -->
					<div class="review_re_table"
						id="review_re<%=review_re_VO.getREVIEW_NUM() %>">
						<div class="row pb-3">
							<div class="col-1"></div>
							<div class="col-11">
								<div class="review_re_sum justify-content-center pr-2">
									<div class="row review_re_space justify-content-center"
										id="review_re_space<%=reviewVO.getREVIEW_NUM() %>">
										<div class="col-1 justify-content-end">
											<img src="<%=member_re_VO.getMEMBER_PICTURE() %>" alt=""
												class="rounded-circle">
										</div>
										<div class="col-11">
											<div class="row">
											...
											<div class="row">
												<!-- content출력 -->
												<div class="col rep_content"
													id="review_RE_modify_block<%=review_re_VO.getREVIEW_NUM() %>"><%=review_re_VO.getREVIEW_CONTENT() %></div>
												<!-- 수정폼(처음에 hidden -->
												<div class="col">
													<form name="review_RE_modifyform"
														id="review_RE_modifyform<%=review_re_VO.getREVIEW_NUM() %>">
														<input type="hidden" name="REVIEW_NUM"
															value="<%=review_re_VO.getREVIEW_NUM() %>">
														<textarea rows="2" name="REVIEW_CONTENT" cols="80%"
															class="review_RE_modify_hidden"
															id="review_RE_modify_hidden<%=review_re_VO.getREVIEW_NUM() %>">
                                             <%=review_re_VO.getREVIEW_CONTENT() %>
                                          </textarea>
													</form>
												</div>
											</div>
											<div class="review_RE_control pr-3"
												id="review_RE_control<%=review_re_VO.getREVIEW_NUM() %>">
												<a class="review_RE_modify" style="cursor: pointer;"> <input
													type="hidden" name="REVIEW_NUM"
													value="<%=review_re_VO.getREVIEW_NUM() %>"> 수정
												</a> &nbsp; <a class="review_RE_delete" style="cursor: pointer;">
													<input type="hidden" name="REVIEW_NUM"
													value="<%=review_re_VO.getREVIEW_NUM() %>"> 삭제
												</a>
											</div>
											<div class="review_RE_control_hidden pr-3"
												id="review_RE_control_hidden<%=review_re_VO.getREVIEW_NUM() %>">
												<a class="review_RE_modify_Process" style="cursor: pointer;">
													<input type="hidden" name="REVIEW_NUM"
													value="<%=review_re_VO.getREVIEW_NUM() %>"> 수정하기
												</a>
											</div>
										</div>
									</div>
               ...
               %>
					<input type="text" id="comment_info" value="등록된 댓글이 없습니다" readonly
               ...
               %>
					...
					<!-- 리뷰 등록하기 -->
					<br />
					<div class="review_add_section justify-content-center"
							...
							<div class="review_hidden">
								<div class="review_grade">
									<img
										...
										alt="" width="15px" height="15px"> &nbsp; : &nbsp; <input
										type="text" name="REVIEW_GRADE" size="3" style="height: 90%;">
									&nbsp;/5.0
								...
								<div class="review_file_upload pb-2">
									<div class="row pt-2 pb-2">
										<div class="input_wrap">
											<input multiple="multiple" type="file" name="REVIEW_FILE"
												id="input_imgs">
										</div>
									</div>
									<div>
								...
								<div class="row justify-content-center pb-3">
									<textarea name="REVIEW_CONTENT" id="REVIEW_CONTENT"
										placeholder="후기를 작성해주세요!" cols="90%" rows="5"></textarea>
								</div>
								<div class=" row justify-content-center pb-3">
									<button class="btn btn-dark btn-sm" id="review_insert"
            ...
            %>
				...
				<div class="qnas_table">
					...
					<div class="qna_sum justify-content-center">
						<div class="row qnaspace">
							<!-- justify-content-center qnaspace -->
            ...
            %>
					<input type="text" id="qna_info" value="등록된 질문이 없습니다" readonly
						style="border: none; text-align: center;">
					<%
               }
            %>
 ...
 --%>
					...
					<!-- qna 등록하기 -->
					<br />
					<div class="qna_add_section justify-content-center"
						style="width: 100%; margin: 0 auto;">
						<div class="row justify-content-center">
							<div class="col-10">
							...
							<div class="col-1">
								<div class=" row justify-content-center">
									<a class="btn btn-outline-dark btn-sm "
										onClick="location.href='#'" style="cursor: pointer;">등록</a>
								</div>
							</div>
						</div>
					</div>
				...
				<br /> <br />
				<div class="ship_info"
					style="width: 100%; margin: 0 auto; font-size: 0.9em; color: #212529;">
					<div class="row_ship_info">
						<h5>배송정보</h5>
						모든 제품은 메이킹퍼니처 직원이 직접 배송하며 배송비는 고객 부담입니다. 지역, 제품 수량 또는 설치 여부에 따라 주문
						시 배송비를 미리 안내해드립니다. 기본 배송비 외에 사다리차, 엘레베이터, 주차비 사용료 등 추가 비용이 발생 시
						고객님 부담입니다.
					...
					<div class="row_ship_info">
						...
						시 배송비를 미리 안내해드립니다. 기본 배송비 외에 사다리차, 엘레베이터, 주차비 사용료 등 추가 비용이 발생 시
						고객님 부담입니다. 반품 배송지 :
						<%=vo.getPRODUCT_SHIP_RETURN_PLACE()%>
					</div>
					<br />
					...
					<div class="row_ship_info">
						<h5>A/S</h5>
						핸드메이드 제품으로 나뭇결, 무늬, 옹이의 형태나 파임, 칠과 색상이 다를 수 있고 약간의 흠집이나 찍힘(표면의 크랙
						또는 뜯김)이 있을 수 있으며, 100% 원목으로 기후변화에 따른 수축, 팽창으로 인한 휘어짐(상판),
						갈라짐(마구리면)이 발생할 수 있습니다. 이런 자연스러운 현상들은 교체 및 교환 대상이 아니며 무상 A/S 사유가 되지
						않습니다. 구매 전 꼭 참고해주시기 바랍니다.
					...
					<div class="row_ship_info">
						...
						원목가구의 수축 및 팽창은 원목만의 자연스러운 특징입니다.<br /> -지나치게 건조한 곳, 습한 곳은 피하세요.
						-가구의 수평을 유지해주세요.(수평이 안 맞게 되면 가구가 뒤틀려버립니다.) -가구에 화학약품(신나, 메니큐어 등)이
						닿지 않게 해주세요. -평소에는 물걸레 청소하시면 됩니다. -뜨거운 냄비와 같은 고온의 뜨거운 물체에 직접 닿는 것은
						피하시기 바랍니다. -한 달에 1~2번 가구용 왁스로 닦아주세요. -원목가구는 수축기와 팽창기(계절의 변화)에 따라
						갈라짐이나 미세한 크랙이 발생할 수 있으며, 시간이 경과하면 원상회복이 될 수 있습니다. 이는 원목가구만의 자연스러운
						현상이며 제품의 하자가 아닙니다.
					...
					<div class="row_ship_info">유상 A/S -고객의 취급 부주의 및 고의적 훼손 경우 -고객
						임의 개조에 의한 파손의 경우나 타 업체에서 수리해 변경된 경우 -유상 서비스 요금은 [수리비+부품비+출장비+기타실
						비용] 등이 포함됩니다.</div>
				</div>
					...
					<form name="goodsform" action="#" method="post">
						<div class="row pt-4 pl-4">
							...
							<div class="col-9">
								...
								<p>
									<font size="2"><%=vo.getPRODUCT_TITLE()%></font>
								</p>
							</div>
						</div>
						<div>
								...
								<tbody>
									...
									<tr>
										...
										<td><select name="size" size="1">
												<option value="">선택</option>
												<c:forTokens var="size" items="<%=PRODUCT_SIZE %>"
													delims=",">
									...
									<tr>
										...
										<td><select name="option" size="1">
												<option value="">선택</option>
												<c:forTokens var="option" items="<%=PRODUCT_OPTION %>"
													delims=",">
									...
									<tr>
										...
										<td><input name="amount" type="text"
											style="text-align: right" value="1" size="4" /> <a
											href="JavaScript:count_change(0)">▲</a> <a
											href="JavaScript:count_change(1)">▼</a> 개</td>
									</tr>
									<tr>
						...
						<div class="btnArea text-center">
							<a href="#" class="btn btn-outline-dark btn-md " role="button"
								aria-pressed="true" id="LikeAjax"> <input type="hidden"
								name="PRODUCT_NUM" value="<%=PRODUCT_NUM %>"> ♥
							</a> <a href="classreservation.ac"
								class="btn btn-outline-dark btn-md" role="button"
								aria-pressed="true">장바구니</a> <a href="#"
								class="btn btn-outline-dark btn-md" role="button"
								aria-pressed="true">바로구매</a>
						</div>
						<br />
					</form>
