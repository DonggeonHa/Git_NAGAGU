...
<head>
    ...
    <!-- 페이지 고유 스타일 -->
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/Mypage/Workshop/review_academy.css">
        ...
        <div class="work_store_body">
            <div class="work_title">
                ...
                <div class="header2 row p-2">
                    <h1 class="col-3 header2_adj">강의 후기</h1>
