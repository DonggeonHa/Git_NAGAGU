	        ...
	        <div class="d-flex justify-content-between pb-2">
				<div class="d-flex justify-content-start">
					...
					<div class="select3" style="padding-left:5px">
						<select class="search_hidden_state justify-content-start form-control" id="selectClassType3" name="selectClassType3" onchange="btn_select3()" style="height: 33px;">
					...
					<div class="select4" style="padding-left:5px">
						<select class="search_hidden_state justify-content-start form-control"  id="selectCategory1" name="selectCategory1" onchange="btn_select4()" style="height: 33px;">
					...
					<div class="select5" style="padding-left:5px">
						<select class="search_hidden_state justify-content-start form-control"  id="selectCategory2" name="selectCategory2" onchange="btn_select5()" style="height: 33px;">
...
<script>
	...
	$(document).on('click', '#listall', function(event) {
		...
		$("#selectClassType3").val('all').prop("selected", true);
	...
	function btn_select3() {		
		console.log("$('#selectClassType3 option:selected').val() : "+$("#selectClassType3 option:selected").val())
		$('#ClassQnaList').empty();
		ClassQnaList();
	}	
	...
	function btn_select4() {		
		console.log("$('#selectCategory1 option:selected').val() : "+$("#selectCategory1 option:selected").val())
	...
	function btn_select5() {		
		console.log("$('#selectCategory2 option:selected').val() : "+$("#selectCategory2 option:selected").val())
	...
	function ClassQnaList() {
		...
		var selectClassType3 = $("#selectClassType3 option:selected").val();	//필터 값 가져오기
		...
		console.log("selectClassType3="+selectClassType3)
				...
				if(qnaList.length!=0) {
					...
					var myreply = new Array();
			     	for(var j=0; j<qnaList.length; j++){
			      		...
			      		var CLASS_STATUS = qnaList[j].CLASS_STATUS;
			      		switch(CLASS_STATUS){
			      	    case 0 : 
			      	    	CLASS_STATUS = '강의종료'
			      	        break;
			      		...
			      		var class_category = qnaList[j].CLASS_CATEGORY;
			      		var CLASS_AREA = qnaList[j].CLASS_AREA;
			      		var CLASS_DIVISION = qnaList[j].CLASS_DIVISION;
			      		var MEMBER_NICK = qnaList[j].MEMBER_NICK;
			    		var CLASS_NAME = qnaList[j].CLASS_NAME;
			    		var CLASS_NUMBER = qnaList[j].CLASS_NUMBER;
