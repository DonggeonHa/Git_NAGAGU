...
<div id="page-content-wrapper" style="padding-top: 5%;">
	<div class="container-fluid">
		...
		<div class="d-flex justify-content-center">
			<nav aria-label="Page navigation example" class="paginated" id="academyQnA-page"></nav>
		</div>
	</div>
</div>
<!-- /본문 -->
...
// 	});
	...
	function page() { 	
		...
		$('nav.paginated').each(function() {
			var pagesu = 10;  //페이지 번호 갯수
	  		...
	  		var $table = $('#academy-qna');    
	  		var $user = $('#academyQnA-page');
	...
	$(document).ready(function() {
		$("#keyword").keyup(function() {
			var k = $(this).val();
			$("#academy-qna > tbody > tr").hide();
			var temp = $("#academy-qna > tbody > tr > td:nth-child(10n+2):contains('" + k + "')");
