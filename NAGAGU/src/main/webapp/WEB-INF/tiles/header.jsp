				...
				<div class="header_util">
					<ul>
						...
						<li>
									...
									<li>
										<div class="dropdown">
											...
											<div class="dropdown-content">
												...
												<a href="#" onclick="window.open('receiveList.nt', 'new', 'scrollbars=yes, resizable=yes, width=540, height=620, left=0, top=0');" style="text-decoration: none;">쪽지</a>
											</div>
										</div>
									</li>
							<%
							...
							%>
									<li>
										<a onclick="window.open('receiveList.nt', 'new', 'scrollbars=yes, resizable=yes, width=540, height=620, left=0, top=0');"><i class="fas fa-envelope" style="width: 20px; height: 25px;"></i></a>
									</li>
									<li>
