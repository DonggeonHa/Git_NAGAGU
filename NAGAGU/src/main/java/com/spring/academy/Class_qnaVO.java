...
public class Class_qnaVO {
	private int QNA_NUM;
	private int QNA_MEMBER;
	...
	public int getQNA_MEMBER() {
		return QNA_MEMBER;
	}
	public void setQNA_MEMBER(int qNA_MEMBER) {
		QNA_MEMBER = qNA_MEMBER;
	}
	public int getQNA_CLASS() {
		return QNA_CLASS;
	}
	public void setQNA_CLASS(int qNA_CLASS) {
		QNA_CLASS = qNA_CLASS;
	}
